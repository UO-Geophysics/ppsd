...
# 1 day
stream = read("/Users/loispapin/Documents/Work/PNSN/2011/Data/B017/B017.PB.2011.185")
trace  = stream[2] #Composante Z

# Cut of the data on choosen times
# starttime = UTCDateTime("2011-07-03T02:30:00.000")
# endtime  = starttime+3600
# st=read("/Users/loispapin/Documents/Work/PNSN/2011/Data/B017/B017.PB.2011.184",starttime=starttime,endtime=endtime)
# trace  = stream[2] #Composante Z
...
ppsd_length                    = 3600 #1-hour segment length
overlap                        = 0.5
    ...
    while t1 + ppsd_length - trace.stats.delta <= t2:
        if check_time_present(times_processed,ppsd_length,overlap,t1):
            ...
            slice = trace.slice(t1, t1 + ppsd_length -
                                trace.stats.delta)
            success = process(leng=leng,nfft=nfft,sampling_rate=sampling_rate,
                              nlap=nlap,psd_periods=psd_periods,
                              period_bin_left_edges=period_bin_left_edges,
                              period_bin_right_edges=period_bin_right_edges,
                              trace=slice,times_processed=times_processed,
                              binned_psds=binned_psds,metadata=metadata,iid=iid)
...
# Init (useless variables in stack_selection)
...
selected = stack_selection(current_times_all_details,times_processed,
                           ...
                           time_of_weekday=time_of_weekday, 
